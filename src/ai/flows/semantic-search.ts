...
const SemanticSearchInputSchema = z.object({
  question: z.string().describe('The question to search for relevant information.'),
  pdfContent: z.string().describe('The extracted text content from the PDF documents.'),
});
export type SemanticSearchInput = z.infer<typeof SemanticSearchInputSchema>;

const SemanticSearchOutputSchema = z.object({
  excerpts: z.array(z.string()).describe('The relevant text excerpts from the PDF content.'),
});
